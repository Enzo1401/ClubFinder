...
export default function Index() {
  return (
    <ScrollView style={styles.container}>
      ...
      <Image
        source={require('../assets/images/loft.png')} // Chemin vers votre image
        style={styles.image}
      />
      ...
      <View>
        ...
        <Image
          source={require('../assets/images/naza.png')}
        ...
        <View>
          ...
          <Text style={styles.reservText}> Réserver sa place maintenant </Text>
          </TouchableOpacity>
        </View>
      </View>
